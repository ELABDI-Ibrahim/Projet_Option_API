...
class DescriptionMergerNLP:
    ...
    def _is_semantically_present(self, candidate_span, existing_sentences_text, threshold=0.85):
...
if __name__ == "__main__":
    ...
    linkedin_path = r"Resumes LinkedIn/ibrahim_elabdi_profile.json"

    with open(resume_path, "r", encoding="utf-8") as f: resume_data = json.load(f)
    with open(linkedin_path, "r", encoding="utf-8") as f: linkedin_data = json.load(f)
